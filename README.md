...
The following graphs and comparisons are recommended to further refine the analysis.
 - **Comparison of launch date that includes both the year and month.** By including the year we could determine if outcomes were affected by the year, or year and month, of the launch. 
